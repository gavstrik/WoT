...
def tabulated_stats(df1):
    ...
    N_hist = N_max = 0
    turkerdict = {k:0 for k in df1.mturker.unique()}
    ...
    for session in sessions:
        ...
        for turker in df.mturker.unique():
            turkerdict[turker] += 1
...
df_all = df_all[df.method != 'file']
df_all = df_all[df.v != 27]
...
print('unique turkers in total:', len(df_all.mturker.unique()))
