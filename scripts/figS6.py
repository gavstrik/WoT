...
"""
This python script plots spanning trees / hamilton trees.
"""
...
def plotting_tree(df_all):
    ...
    plt.savefig(os.path.join(PLOTS_DIR, 'figS6.png'), transparent=True, bbox_inches='tight', dpi=400)
    plt.savefig(os.path.join(PLOTS_DIR, 'figS6.pdf'), transparent=True, bbox_inches='tight', dpi=400)
    plt.show()
...
# choose the threads:
df_all = df_all[(df_all.session == 'hhb0if6e') | (df_all.session == '44qx5qq5')]
