...
\twocolumn[
  \begin{@twocolumnfalse}
    ...
    \begin{abstract}
\noindent
Social decision-making is increasingly relying on digitized aggregates of people’s opinions and judgments. These aggregates are frequently maintained as threads, i.e. as sequences of posts on a website. While it has been shown that knowledge of thread aggregates can distort decision-making, it is unknown how seeing preceding posts may alter individual judgment and collective accuracy. We investigate experimentally the accuracy of threads in which people make magnitude estimations of varying difficulty and varying degrees of social information in the form of visible previous estimates. We find a significant increase in collective accuracy in difficult threads when the social information is pristine and  high levels social information in pristine threads, while collective accuracy declines quickly in manipulated threads. Using gaussian mixture models we assign a persuadability score to each participant, and show that persuadability generally increases with task difficulty and with the amount of social information. In the case of strong manipulation, we may see a split between a minority of persuadables and a majority of skeptics.

Online discussion threads are important means for individual decision-making as well as for aggregating collective judgments, e.g the 'wisdom of crowds’. Empirical and theoretical investigations of the wisdom of crowds are currently ambivalent about the role played by social information. While some findings suggest that social information undermines crowd accuracy due to correlated judgment errors, others show that accuracy improves. We investigate experimentally the accuracy of threads in which people make magnitude estimations of varying difficulty while seeing a varying number of previous estimates. We find a significant increase in collective accuracy in pristine threads that have high levels of difficulty and a high number of visible preceding estimates,
 while collective accuracy declines quickly in manipulated threads.


We demonstrate that, for difficult tasks, seeing preceding estimates in a thread aids individual decision-making as well as the wisdom of crowds. If, however, threads are filtered so that people only see the most extreme estimates, wisdom quickly turns into folly.% due to a significant fraction of people who either compromize on the social information given, or follow it blindly.
\\
\end{abstract}
  \end{@twocolumnfalse}
]
...
\begin{figure}
	...
	\begin{subfigure}{.49\linewidth}
		\subcaptionbox{Thread with $d=55$ dots and $v=1$ estimates.}
		...
		\subcaptionbox{Thread with $d=55$ dots and $v=3$ estimates.}		
		...
		\subcaptionbox{Thread with $d=148$ dots and $v=3$ estimates.}		
		...
		\subcaptionbox{Thread with $d=403$ dots and $v=9$ estimates.}		
		...
		\subcaptionbox{Thread with $d=1097$ dots and $v=9$ estimates.}		
